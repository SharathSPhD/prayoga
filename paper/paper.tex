...
\section{Temporal Dynamics of Symmetry Breaking}
\label{sec:dynamics}
...
\conflictsofinterest{The author declares no conflict of interest. \textbf{Dual-use
statement:} this work characterizes ablation (``abliteration'') directions and
